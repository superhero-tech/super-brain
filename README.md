...
Raw sources go in, a linked wiki comes out, and every question you ask is answered from that wiki instead of from scratch. Projects live alongside the wiki with their own briefs, rules and logs. The AI knows you from a profile file, not a system prompt - so it moves with you between tools.
